...
We would like you to construct a simple HTTP load generator using modern C# async practices. It should accept an input file
...
This task should be timeboxed at somewhere around 6 hours; we are not expecting a world-class application, but merely
...
DETAILS:
   ...
   * Permissions (in Header): 'X-Api-Key: INSERT_YOUR_KEY'
...
SUBMISSION:
Please email your completed solution back to us at mbenua@mparticle.com. It should be in a zip file, and you will have to remove 
executables or Google will helpfully remove your attachment. We will recompile and execute your program from here, and run any unit tests
you may provide. Please also include the version of IDE you used and any execution instructions or caveats that you feel may be necessary to execute your application.

Thank you! We look forward to speaking with you further about your work!
